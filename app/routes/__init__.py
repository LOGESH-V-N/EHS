...
from .query_resolution_routes import query_resolution_bp
...
def register_routes(app):
    ...
    app.register_blueprint(integration_bp, url_prefix="/app-configurations")
    app.register_blueprint(query_resolution_bp, url_prefix="/query")
